...
test_that("filter_route_id - errors and warnings", {
  ...
  # Wrong keep input
  testthat::expect_error(filter_route_id(gtfs = gtfs, route_ids= "6450-51", keep= 99999))

  # Wrong gtfs input
  testthat::expect_error(filter_route_id(gtfs = 'abcdefg'))

  # Wrong route_ids input
  testthat::expect_error(filter_route_id(gtfs = gtfs, route_ids= 99999))

  # No routes files
  gtfs$routes <- NULL
  testthat::expect_error(filter_route_id(gtfs = gtfs, route_ids= "6450-51"))
